...
## Docker Image
```
docker pull muaeabudhabi/watchparty-v2:latest
```

## Install on Unraid
1. Download `unraid-templates/my-watchparty-v2.xml`
2. Copy to `/boot/config/plugins/dockerMan/templates-user/`
3. Docker tab → Add Container → select `watchparty-v2`
